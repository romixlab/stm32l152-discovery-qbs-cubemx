...
extern unsigned char Bias_Current;    /* Bias Current stored in EÂ²Prom used for ICC mesurement precision */
...
uint16_t Int_CurrentSTBY;             /* */
  ...
  uint8_t message[29] = "     ** 32L152CDISCOVERY  **";
	#else
        uint8_t message[29] = "     ** Qt Creator Build Test **";
#endif
/*******************************************************************************/
/**
...
{ 
 ...
 /*!< At this stage the microcontroller clock setting is already configured, 
  ...
  {
    /* Measure operational amplifier bias current and store value in EÂ²Prom for application need*/
    Bias_measurement();
  }
